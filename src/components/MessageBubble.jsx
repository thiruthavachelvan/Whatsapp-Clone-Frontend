      ...
      >
        ...
        <div className="flex flex-col w-full pr-10 min-w-0">
          ...
          <div className="absolute bottom-[2px] right-1.5 flex items-center">
            ...
            {isOwn && (
              <span className={`ml-[2px] transition-colors duration-300 ${message.isRead ? 'text-[#34b7f1]' : 'text-[#8696a0]'}`}>
                {message.isRead ? (
                  /* Double Blue Ticks */
                  ...
                  /* Single Gray Tick */
                  <svg viewBox="0 0 16 15" width="11" height="15" className="fill-current">
